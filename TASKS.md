...
- [x] **Mission Control Booking Detail Redesign Slice** (2026-04-30)
  ...
  - [x] Removed duplicate seat-selection buttons from Settlement; seat switching now lives only in the Seats panel
  - [x] Emphasized the Seat Ledger print and collect actions, including a high-contrast Collect amount CTA
  - [x] Moved the Collect amount CTA under the selected-seat Payment summary Total/Remaining lines
- [x] **Mission Control Booking Detail Middle Panel Breakdown Prototype** (2026-05-02)
  - [x] Prototyped splitting the large middle Seat Ledger surface into separate Seat Ledger, Seat Totals, Orders, Payment, and Payment Records panels
...
- [x] **Mission Control Booking Detail Add Custom Item Modal** (2026-05-03)
  - [x] Restyled the Add Custom Item dialog with the shared MC dialog frame, header, body, footer, compact item/price inputs, preview subpanel, and close control
  - [x] Reused the canonical Mission Control room/timeline seat color cycle for custom-item destination choices
  - [x] Right-aligned the Add Custom Item dialog Cancel action with the reusable MC footer modifier
  - [x] Preserved the existing custom item behavior and form reset after a successful add/cancel
  - [x] Added focused Playwright coverage for opening the modal, enabling seat actions, adding a custom item, and verifying it appears on the destination seat
  - [x] Captured a review screenshot at `test-results/booking-detail-add-custom-item-modal-prototype.png`
- [x] **Mission Control Booking Detail Add Discount Modal** (2026-05-03)
  - [x] Restyled the Add Discount dialog with the shared MC dialog frame, header, body, footer, compact discount inputs, type toggle, preview subpanel, and close control
  - [x] Reused the canonical Mission Control room/timeline seat color cycle for discount destination choices
  - [x] Right-aligned the Add Discount dialog Cancel action with the reusable MC footer modifier
...
- [x] **Mission Control Booking Detail Gift Card Sale Modal** (2026-05-03)
  - [x] Restyled the Gift Card Sale dialog with the shared MC dialog frame, header, body, footer, preset amount controls, custom amount input, preview subpanel, and close control
  - [x] Reused the canonical Mission Control room/timeline seat color cycle for gift-card destination choices
  - [x] Right-aligned the Gift Card Sale dialog Cancel action with the reusable MC footer modifier
